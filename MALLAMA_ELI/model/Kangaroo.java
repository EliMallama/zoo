...
public class Kangaroo {
	...
	public String timeToVaccine(int year,int month,int day) 
	{
		String timeTo="";
		...
		if(years>=1) {timeTo="Vaccine is not required";}
		else {timeTo=weeks+" weeks and "+days+ " days left to the vaccine";}
	   return timeTo;
	}
	...
	public String toString() 
	{
		return "name="+ name + ", weight=" + weight + ", height=" + height + ", sex=" + sex + ", bloodType="
				...
				+ ", BMI=" + bmi + ", " + calculateDiet()+ ", "+calculateRisk()+", "+calculateWater();
	}
